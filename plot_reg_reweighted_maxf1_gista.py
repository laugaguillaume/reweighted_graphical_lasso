...
BASEDIR = Path(__file__).resolve().parent / "bench_results" / "gista"
...
plt.tight_layout()
plt.savefig(
    f"bench_results/GISTA_reweights_p_75_n_1000_alpha_0.9_max_F1.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig(
    f"bench_results/GISTA_iterations_p_75_n_1000_alpha_0.9_max_F1.pdf")
plt.show()