...
plt.savefig(
    f"./bench_results/pglasso/p{p}_n{n}_alpha{sparsity}_{data_type}_max_iter_reweights_{max_iter_reweights}_gridsize_{grid_size}_.pdf")
plt.show(block=False)
pd.DataFrame(csv_rows).to_csv(f"./bench_results/pglasso/p{p}_n{n}_alpha{sparsity}_{data_type}_max_iter_reweights_{max_iter_reweights}_gridsize_{grid_size}_glasso_summary.csv", index=False)
